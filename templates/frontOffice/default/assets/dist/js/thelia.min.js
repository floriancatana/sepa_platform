...
$( ".wish-list a" ).click(function(e) {

  var id = $(this).next('input').val();
  
  if($(this).parent('.wish-list').hasClass("in-wish-list")) {
...
function addWishList(object, id) {
    $.ajax({
    	...
    	object.parent('.wish-list').addClass("in-wish-list");
...
function removeWishList(object, id) {
    $.ajax({
    	...
    	object.parent('.wish-list').removeClass("in-wish-list");
    	object.attr("href", "/wishlist/add/"+id);
    });
}

$( ".nav-breadcrumb .view-mode .btn" ).click(function(e) {

	$productList = $('#content .col-main');
	$grid = $('.nav-breadcrumb .view-mode-btn .grid');
	$list = $('.nav-breadcrumb .view-mode-btn .list');
...
$( window ).resize(function() {
	if($(window).width() < 768){
		if($( ".nav-breadcrumb .view-mode .btn" ).hasClass('list')) {
			
			$('#content .col-main').removeClass('list').addClass('grid');
			$('.nav-breadcrumb .view-mode-btn .list').removeClass('active');
	        $('.nav-breadcrumb .view-mode-btn .grid').addClass('active');
		}
	}
});
